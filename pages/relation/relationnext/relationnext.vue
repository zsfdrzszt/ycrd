		...
		<view class="textcon">
			...
			<scroll-view scroll-y  class="scrollheight" >
				<view class="scrolllist" v-show="0==isActive">
					<spacewindow v-for="(item,index) in list" :key="index" :space="item.name" :id="item.id"></spacewindow>
				</view>
		...
		data() {
			return {
				...
				list: [{
					...
					id:2,
					name: "西南街道",
					space:["苏村活动室","聂店活动室","小峪口活动室","河口活动室"]
				},{
					id:3,
					name: "乌金山镇",
					space:["小张义活动室","张庆活动室","永康活动室",]
				}, {
					id:4,
					name: "修文镇",
					space:["南疃活动室","镇政府工作室","东长寿活动室","褚村活动室","杨安活动室","中郝活动室"]
				},{
					id:5,
					name: "张庆乡",
					space:["东阳镇活动室","王寨活动室","彭村活动室","逯村活动室","北社活动室 "]
				},  {
					id:6,
					name: "长凝镇",
					space:["西墕沟活动室"]
