...
<script>
	...
	export default {
		...
		data() {
			return {
				isActive:1,
				txt:[{content:"人大代表接待选民制度"},{content:"人大代表联系选民制度"},{content:"人大代表走访选民制度"},{content:"人大代表接待选民制度"}],
				txt1:[{content:"郭家堡乡人大代表“三级体系”“智慧人大”信息平台推进会",time:"2021-3-5"},{content:"全乡新冠肺炎疫情防控工作再部署会",time:"2020-3-5"},{content:"学习申纪兰精神，做人民好代表，郭家堡乡人大主席团交流会",time:"2020-2-1"}],
			}
		},
		methods: {
			changestate(n){
